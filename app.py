...
async def teamConfig(task_user):
    ...
    PlanningAgent = AssistantAgent(
        ...
        โดยที่เราจะจัด Debate ต่อเนื่องกันรอบละ 1 ครั้ง และจบที่หลังจากที่ John และ Jack Debate มาแล้วครบ 1 ครั้ง เราถึงสรุปรอบท้าย
        โดยเริ่มจากคุณเป็นกรรมการ และเริ่มจาก Jack จากนั้นไปที่ John และไปที่คุณ วนไปเรื่อย ๆ จนกว่าจะครบ 1 ครั้ง
    ...
    JackAgent = AssistantAgent(
        ...
        โดยที่เราจะจัด Debate ต่อเนื่องกัน 1 ครั้ง และจบที่ครั้งที่ 1
